...
<div class="section-header" style="margin-top:4px">今天也适合</div>
<div class="rec-cards" id="suitable-cards">
{card4}
{card5}
{card6}
</div>
<div style="text-align:center;padding:8px 0 16px"><span style="font-size:13px;color:var(--navy);cursor:pointer;font-weight:600" onclick="refreshAlts()">⟳ 换一批</span></div>
</div>
...
function refreshAlts(){{var alts=[['日系 City Boy','TS-011 落肩T恤 / SHIRT-001 条纹衬衫'],['轻熟休闲','SHIRT-003 牛津衬衫 / PT-005 西裤'],['韩系简约','TS-010 条纹T恤 / PT-006 直筒牛仔裤'],['Clean Fit','TS-009 短袖 / PT-002 牛仔裤'],['街头潮流','TS-006 黑T / JK-003 棒球服'],['运动休闲','TANK-001 背心 / SH-001 速干短裤']];var pool=alts.sort(function(){{return Math.random()-0.5}}).slice(0,3);var h='';pool.forEach(function(a){{h+='<div class=\"rec-card\" onclick=\"this.classList.toggle(\\'open\\')\"><div class=\"rc-style-name\">'+a[0]+'</div><div class=\"rc-items\"><div>'+a[1]+'</div></div><div class=\"rc-arrow\">▾</div></div>'}});var el=document.getElementById('alt-cards');if(el)el.innerHTML=h;var h2='';pool.slice(0,3).forEach(function(a){{h2+='<div class=\"rec-card\" onclick=\"this.classList.toggle(\\'open\\')\"><div class=\"rc-style-name\">'+a[0]+'</div><div class=\"rc-items\"><div>'+a[1]+'</div></div><div class=\"rc-arrow\">▾</div></div>'}});el=document.getElementById('suitable-cards');if(el)el.innerHTML=h2}}
...
card3 = mini_card('晴日 Clean Fit', ['TS-009 Lululemon 短袖', 'PT-002 直筒牛仔裤', 'SHOE-006 Converse 帆布鞋', 'SOCK-001 船袜'])
card4 = mini_card('日系 City Boy', ['TS-011 落肩T恤', 'SHIRT-001 条纹衬衫', 'PT-001 宽松牛仔裤', 'SHOE-009 AF1 板鞋'])
card5 = mini_card('轻熟休闲', ['SHIRT-003 牛津衬衫', 'PT-005 休闲西裤', 'SHOE-009 皮质板鞋', 'ACC-001 手串'])
card6 = mini_card('街头潮流', ['TS-006 宽松黑T', 'JK-003 皮质棒球服', 'PT-004 工装裤', 'SHOE-008 AJ 球鞋'])
