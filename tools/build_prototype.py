...
function refreshAlts(){{var alts=[['日系 City Boy','TS-011 落肩T恤 / SHIRT-001 条纹衬衫 / SHOE-009 AF1'],['轻熟休闲','SHIRT-003 牛津衬衫 / PT-005 西裤 / SHOE-009 板鞋'],['韩系简约','TS-010 条纹T恤 / PT-006 直筒牛仔裤 / SHOE-005'],['Clean Fit','TS-009 短袖 / PT-002 牛仔裤 / SHOE-006'],['街头潮流','TS-006 黑T / JK-003 棒球服 / SHOE-008'],['运动休闲','TANK-001 背心 / SH-001 速干短裤 / SHOE-003']];var pool=alts.sort(function(){{return Math.random()-0.5}}).slice(0,3);var h='';pool.forEach(function(a){{h+='<div class=\"rec-card\" onclick=\"this.classList.toggle(\\'open\\')\"><div class=\"rc-style-name\">'+a[0]+'</div><div class=\"rc-items\"><div>'+a[1]+'</div></div><div class=\"rc-arrow\">▾</div></div>'}});var el=document.getElementById('alt-cards');if(el)el.innerHTML=h}}
