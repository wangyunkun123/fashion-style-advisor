#!/usr/bin/env python3
"""Seedream 生图 — 针对 2026-06-10 骑行通勤 v2"""
import os, json, base64, urllib.request, time, io, sys
...
OUTFIT_DIR = os.path.join(PROJECT, 'outfits', '2026-06-10_骑行通勤_v2')
...
def main():
    print("=" * 60)
    print("🎨 Seedream API 生图 — 骑行通勤 v2")
    print("=" * 60)

    # 收集参考图
    refs = []
    for prefix in ['人物_', '上衣_', '下装_', '鞋子_']:
