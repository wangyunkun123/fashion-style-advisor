...
.es-item-chip{{background:#f0f4f8;border-radius:8px;padding:3px}}
.es-item-chip img{{width:32px;height:32px;border-radius:6px;object-fit:cover;display:block;cursor:pointer}}
